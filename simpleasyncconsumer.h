#ifndef SIMPLEASYNCCONSUMER_H
#define SIMPLEASYNCCONSUMER_H
...
class SimpleAsyncConsumer : public QObject,
...
private:
    ...
    void cleanup();
signals:
    void sendMessage(CommEventLog);
public slots:
    
};

#endif // SIMPLEASYNCCONSUMER_H
